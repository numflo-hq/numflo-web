...
test.describe("matching browser language", () => {
  ...
  test("no suggestion banner when the page matches the browser", async ({ page }) => {
    await page.goto("/");
    await expect(page.locator("[data-lang-banner]")).toBeHidden();
  });
});
